...
// EEPROM Memory Region On the Flash.
#define EEPROM_PAGE0_ADDR ( (uint32_t)0x08007800 )
#define EEPROM_PAGE1_ADDR ( (uint32_t)0x08007C00 )
#define EEPROM_LENGTH     128 // ( 128 = 0x0080 )   //

static bool IsInit = false;
static uint16_t VirtAddVarTab[EEPROM_LENGTH];       // Virtual Address Variable Table, Variable virtual Address --> 16bits.


#define PAGE_SIZE         (uint32_t)FLASH_PAGE_SIZE

#define EEPROM_START_ADDRESS ( (uint32_t)EEPROM_PAGE0_ADDR )
